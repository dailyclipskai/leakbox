  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      <div className="glass p-4 mb-3">
        <div className="font-horror text-xl text-primary red-glow">{other?.display_name ?? "..."}</div>
        ...
        {msgs.map((m) => {
          ...
          return (
            <div key={m.id} className={`flex ${mine ? "justify-end" : "justify-start"}`}>
              <div className={`max-w-[75%] px-3 py-2 rounded-lg text-sm ${mine ? "bg-primary text-primary-foreground" : "bg-black/50 border border-primary/30"}`}>
                {m.content}
