...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "LeakBox is a community board for verified boxes. Browse, search, and share." },
      { property: "og:title", content: "LeakBox — Browse community boxes" },
      { property: "og:description", content: "A cyber-horror community board for verified boxes." },
