...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "LeakBox — Browse boxes" },
      { name: "twitter:description", content: "LeakBox Central is a modern cyber-horror website for discovering and sharing community-created \"boxes\" of information." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fafa64af-d43b-4677-a76f-f5ec1fae7145/id-preview-bcf79cdd--04158958-3b6e-4f3a-a146-6254cf3b195c.lovable.app-1785084408259.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fafa64af-d43b-4677-a76f-f5ec1fae7145/id-preview-bcf79cdd--04158958-3b6e-4f3a-a146-6254cf3b195c.lovable.app-1785084408259.png" },
    ],
    links: [
      {
        rel: "stylesheet",
